...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <div class="box_general padding_bottom">
      ...
      <div class="row">
        <div class="col-md-6">
          <button type="submit" class="btn btn-danger mb-3">Tambah</button>
        </div>
    </div>
        </form>
        <div class="table-responsive-sm">
            <table class="table table-bordered">
                ...
                <tr class="text-center">
                    ...
                    <td>{{ $cat->name }}</td>
                    <td>
                        <form action="{{url('dashboard/category_destroy/'.$cat->id)}}" method="POST">
                            <a class="btn btn-primary" data-toggle="modal" data-target="#editModal{{$cat->id}}">Edit</a>
                            @csrf
                            @method('DELETE')
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="{{url('/dashboard/category_editing/'.$cat->id)}}" method="post">
                          @csrf
                          @method('patch')
                          <div class="row">
                            <div class="col-md-6">
