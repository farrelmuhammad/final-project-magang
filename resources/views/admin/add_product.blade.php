...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form method="post" action="{{ url('dashboard/adding')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" type="text" class="form-control" style="height:130px;"></textarea>
                </div>
            </div>
        </div>
        <!-- /row-->
