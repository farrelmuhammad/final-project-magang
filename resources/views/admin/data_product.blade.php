  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">My listing</li>
      </ol>
        ...
        <div class="table-responsive-sm">
            <table class="table table-bordered">
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <form action="{{url('dashboard/destroy/'.$prod->id)}}" method="POST">
                            <a class="btn btn-primary" href="{{url('dashboard/'.$prod->id.'/edit')}}">Edit</a>
                            @csrf
                            @method('DELETE')
