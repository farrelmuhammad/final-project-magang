...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form method="post" action="{{ url('dashboard/editing/'.$id->id)}}" enctype="multipart/form-data">
        @csrf
        @method('patch')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="product_type" class="form-control" value="{{$id->product_type}}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
