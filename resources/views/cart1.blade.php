...
<head>
    ...
    <title>Booking Information | PT. OTAK KANAN</title>
				...
				<div class="row">
							...
							<tbody>
								...
								<tr>
									<td>
										...
										<span class="item_cart">{{$cart->products->name}}</span>
									</td>
									<td>
										0%
									</td>
									<td>
										<strong>Rp{{$cart->products->price}},-</strong>
									</td>
									<td class="options" style="width:5%; text-align:center;">
										<form action="{{url('cart/destroy/'.$cart->id)}}" method="POST">
											@csrf
											@method('DELETE')
							...
							<div class="float-left">
								<div class="apply-coupon">
									<div class="form-group">
										<input type="text" name="coupon-code" value="" placeholder="Kode Kupon" class="form-control">
									</div>
									<div class="form-group">
										<button type="button" class="btn_1 outline">Gunakan Kupon</button>
									</div>
								</div>
							</div>
							<div class="float-right fix_mobile">
								<a class="btn_1 outline" data-toggle="modal" data-target="#editModal{{$cart->id}}">Ubah Pesanan</a>
							</div>
						</div>
						<!-- /cart-options -->
						</div>
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail">
							...
							@if ($cart)
							<a href="{{url('/cart/2')}}" class="btn_1 full-width purchase">Checkout</a>
							@else
							<a href="{{url('/cart')}}" class="btn_1 full-width purchase">Checkout</a>
							@endif
