    ...
    var map = L.map('map', {
        center: [-7.320674, 112.732100],
        minZoom: 2,
        zoomControl: false,
        zoom: 18
    });
    var marker = new L.Marker([-7.320674, 112.732100]);
	marker.addTo(map);
    ...
    L.tileLayer( 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
     ...
     accessToken: 'pk.eyJ1IjoiZmFycmVsbXVoYW1tYWQiLCJhIjoiY2twZ2QycGxvMDR5NDJxbnZoeDc3NGt1MCJ9.3Ez6AGLgLeGVvJWXOn_yBw',// Your Mapbox Access Token
     subdomains: ['a','b','c']
    }).addTo( map );
